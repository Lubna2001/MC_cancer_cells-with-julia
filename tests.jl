...
# make sure to download the package Plots by writing  " import Pkg; Pkg.add("Plots") " in the same folder where you have the julia files

# then load the file Simulation by writing  " include("Simulate.jl") " , you don't need to load MC_cancer_cell_model, since it is already loaded by loading Simulate.jl, 

# because include("MC_cancer_cell_model.jl") is written in Simulate.jl. 

# write using Plots

# write Nc, Nn, snaps = simulate(1; snapshot_times=[150, 200]), where 1 is the number of the seed, you can choose any number for exmple 6 
...
# plot_two_snapshots(snaps, 150, 200; outpath="snapshots_150_200_seed4.png") , and saving them with the name snapshots_150_200_seed4.png
